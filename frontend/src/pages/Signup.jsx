  ...
  return (
    <div className="min-h-screen flex" data-testid="signup-page">
      ...
      <motion.div
        ...
        className="hidden lg:flex lg:w-1/2 bg-gradient-to-bl from-primary/20 to-accent/10 relative overflow-hidden"
      >
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-foreground">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-md">
            Thousands of fleet owners trust us to keep their vehicles compliant
          </p>
        </div>
      </motion.div>
    </div>
